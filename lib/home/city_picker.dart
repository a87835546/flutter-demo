...
class CityPickerPage extends StatefulWidget {
  const CityPickerPage({Key? key,required this.title}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _CityPickerState();
  final String title;

}

class _CityPickerState extends State<CityPickerPage> {
